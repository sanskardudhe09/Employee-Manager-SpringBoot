package com.myspringboot.Employee.Admin.CRUD.config;

import com.myspringboot.Employee.Admin.CRUD.service.CustomSuccessHandler;
...
public class SecurityConfig {
    //config file for spring security
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf(c -> c.disable())
                .authorizeHttpRequests(requests -> requests.requestMatchers("/admin-page").hasAuthority("ADMIN")
                        .requestMatchers("/user-page").hasAnyAuthority("ADMIN", "USER")
